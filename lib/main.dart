...
import 'features/home/screen/detail_doctor_page.dart';
void main() {
  runApp(MyApp());
}
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => AllDoctors()),
      ],
      child: MaterialApp(
        ...
        routes: {
          ...
          DetailDoctorPage.routeName: (context) => DetailDoctorPage(),
        },
      ),
    );
  }
